...
<%--https://search.daum.net/search?nil_suggest=btn&w=tot&DA=SBC&q=%EC%97%90%EC%8A%A4%ED%8C%8C--%>
<c:url value="https://search.daum.net/search.daum" var="daumUrl">
    <c:param name="nil_suggest" value="btn"/>
    <c:param name="w" value="tot"/>
    <c:param name="DA" value="SBC"/>
